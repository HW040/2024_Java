...
public class Rule {
    public void getWinner(Dealer dealer, Gamer gamer) {
        ...
        남은경우: 둘 중의 하나가 21을 넘은 경우, 둘 다 21을 안 남은 경우
        ...
        if ((gamerScore == dealerScore) || (dealerScore > MAX_POINT && gamerScore > MAX_POINT)) {
            System.out.println("비겼습니다");
        } else if ((dealerScore <= MAX_POINT && dealerScore > gamerScore) || gamerScore > MAX_POINT) {
