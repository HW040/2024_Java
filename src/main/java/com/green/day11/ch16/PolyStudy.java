...
public class PolyStudy {
    ...
    멤버메소드 어떻게 동작하는지 이해하면 된다. 아래 3가지로
    1. 부모타입은 변수는 자식객체 주속값 저장할 수 있다.
    ...
    래퍼런스 변수끼리의 형변환이 가능한데 상속관계에서만 가능
    ...
    public static void main(String[] args) {
        ...
        //3번 검증
        //ali3.jimp(); //ani3에는BullDog객체 주소값이 저징되어 있으나
