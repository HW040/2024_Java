...
public class LocalVariable {
    ...
    public static void sum(int n1) {
        int num1 = 11;  //main메소드에서 사용한 변수명이지만 main메소드 중괄호를 벗어나게 되면
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(num2); //{}밖인 num2 의 스코프는 사라졌다 (출력 안됨)
        {
            int num3 = 33;
            num3++;
            System.out.println(num3);
        }
        //System.out.println(num3); //{}밖인 num3의 스코프는 사라졌다.
        int i = 0;
        for (; i < 10; i++) {

        }
        System.out.println(i); // i의 스코프는 for문 바깥에서는 사라진다.
        //for문 초기화 공간에서 생성된 i는
    }
