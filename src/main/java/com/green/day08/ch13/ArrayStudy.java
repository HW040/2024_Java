...
public class ArrayStudy {
    /*
     ...
     그치만 배열을 사용하여 편하게 여러 데이터를 편하게 저장하고 가져올 수 있다.
     (read / write)
     ...
     int[] 변수명 도 가능하고 //Reference변수
     int 변수명[] 도 가능한데 int[] 변수명만 사용해 주세요. 헷갈림!
     ...
     new String[100] String형이 공간이 100개가 만들어졌다.
      각 공간은 String주소값만 저장할 수 있다.

      [배열 쓰기]
      int[] arr = new int[10];
      arr[0] = 10; //첫번째 공간에 10을 대입, 공간번호(index)는 "0부터 시작"
      arr[1] = 20; //두번째 공간에 20을 대입했다

      arr[9] = 100; //마지막 공간에 100을 대입했다

      초기화 하지 않은 공간은 디폴트값이 들어간다. (저장되어있다)
      숫자형은 0, 래퍼런스 타입은 null, boolean은 false

      [배열 읽기]
      System.out.println(arr[0]); // 10
      System.out.println(arr[9]); // 100

      arr.length(상수,정수) 는 자신의 공간의 크기값을 저장한 정수 상수 //10
      ...
      배열과 반복문(for)의 궁합이 좋다. 개부분 함께 쓰인다.
     */
